...
namespace CashFlow.Consolidated.Domain.Gateways
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<ICollection<TOutput>> WhereAsync<TOutput>(Expression<Func<T, bool>> query, Expression<Func<T, dynamic>> selector, CancellationToken cancellationToken = default);
        ...
        Task<TOutput> MaxAsync<TOutput>(Expression<Func<T, bool>> query, Expression<Func<T, TOutput>> selector, CancellationToken cancellationToken = default);
